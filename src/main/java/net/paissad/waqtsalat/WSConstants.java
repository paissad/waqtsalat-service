...
public interface WSConstants {
    ...
    String   WS_VERSION                 = new StringBuilder().append(WS_MAJOR_VERSION + ".")
                                                .append(WS_MINOR_VERSION + ".").append(WS_MICRO_VERSION).toString();
    ...
    String   WS_USER_AGENT              = new StringBuilder().append(WS_NAME + "/").append(WS_VERSION + " (")
                                                .append(OS_NAME + "; U ").append(OS_ARCH + "; ")
                                                .append(OS_VERSION + "; ").append(Locale.getDefault())
                                                .append(") Java/").append(JAVA_VERSION).toString();
    ...
    String   GEOIP_WORLDCITIES_URL      = "http://www.maxmind.com/download/worldcities/" + GEOIP_WORLDCITIES_FILENAME
                                                + ".gz";
